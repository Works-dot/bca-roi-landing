  ...
  return (
    <div style={{ fontFamily: "'Dosis', sans-serif" }}>
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="absolute inset-0" style={{ background: 'hsla(240, 10%, 12%, 0.88)' }} />
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="border border-white/20 p-8 flex flex-col gap-6 relative rounded-[4px] backdrop-blur-sm bg-white/[0.03]">
                ...
                <div className="hidden md:block absolute -right-6 top-1/2 -translate-y-1/2 z-10 p-1 rounded-full" style={{ background: 'hsl(240 10% 13%)' }}>
                  <ArrowRight className="w-8 h-8" style={{ color: 'hsl(359 69% 27%)' }} />
                </div>
              </div>
              <div className="border p-8 flex flex-col gap-6 relative rounded-[4px] backdrop-blur-sm" style={{ borderColor: 'hsl(359 69% 27%)', background: 'hsla(359, 69%, 27%, 0.12)' }}>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="absolute inset-0" style={{ background: 'hsla(359, 69%, 25%, 0.9)' }} />
        <div className="container mx-auto px-4 md:px-8 relative z-10">
