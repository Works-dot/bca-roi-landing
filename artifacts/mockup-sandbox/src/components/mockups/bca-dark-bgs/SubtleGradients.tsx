...
export function SubtleGradients() {
  return (
    <div style={{ fontFamily: "'Dosis', sans-serif" }}>
      <section className="py-24 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, hsl(240 10% 13%) 0%, hsl(240 8% 18%) 40%, hsl(350 15% 16%) 100%)' }}>
        <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse at 30% 50%, hsla(359, 69%, 27%, 0.08) 0%, transparent 60%)' }} />
      ...
      <section className="py-24 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, hsl(359 69% 22%) 0%, hsl(359 69% 30%) 50%, hsl(359 55% 24%) 100%)' }}>
        <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse at 70% 50%, hsla(0, 0%, 100%, 0.06) 0%, transparent 50%)' }} />
        <div className="container mx-auto px-4 md:px-8 relative z-10">
