          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="border border-white/20 p-8 flex flex-col gap-6 relative rounded-[4px] backdrop-blur-sm bg-white/[0.03]">
                ...
                <div className="hidden md:block absolute -right-6 top-1/2 -translate-y-1/2 z-10 p-1 rounded-full" style={{ background: 'transparent' }}>
                  <ArrowRight className="w-8 h-8" style={{ color: GOLD }} />
                </div>
              </div>
              <div className="border p-8 flex flex-col gap-6 relative rounded-[4px] backdrop-blur-sm" style={{ borderColor: GOLD, background: 'hsla(38, 70%, 55%, 0.12)' }}>
                <h3 className="text-xl font-bold tracking-widest uppercase" style={{ color: GOLD }}>Automation</h3>
                <ul className="space-y-4 text-lg font-medium text-white/80">
            ...
            <div className="mt-16 text-center">
              <p className="text-3xl md:text-4xl font-light italic text-white">
                "Small processes. <span className="font-bold not-italic" style={{ color: GOLD }}>Big impact.</span>"
              </p>
            </div>
          </div>
        </div>
