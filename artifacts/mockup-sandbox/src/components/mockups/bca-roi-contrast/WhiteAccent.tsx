        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="border p-8 flex flex-col gap-6 relative rounded-[4px] backdrop-blur-sm" style={{ borderColor: PRIMARY, background: 'hsla(359, 69%, 27%, 0.12)' }}>
              ...
              <div className="p-8 flex flex-col gap-6 shadow-2xl rounded-[4px]" style={{ background: PRIMARY, color: 'white' }}>
            ...
            <div className="mt-16 text-center">
              <p className="text-3xl md:text-4xl font-light italic text-white">
                "Small processes. <span className="font-bold not-italic" style={{ color: PRIMARY }}>Big impact.</span>"
              </p>
            </div>
          </div>
        </div>
